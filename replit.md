...
- **AI Integration**: Gemini 2.5 Flash via Replit AI Integrations (server/ai.ts)
...
### AI Integration
- **Gemini 2.5 Flash**: Via Replit AI Integrations for image analysis and explanations
